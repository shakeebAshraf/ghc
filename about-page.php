...
<section class="container my-5">
    ...
    <div class="row mt-5">
        <div class="col-md-12">
            <p>Heute betreue ich Kunden 360 Grad im eCommerce und Online-Marketing, ob es um die Shopping-Lösung, das Hosting oder <a class="medium-italic text-decoration-none" target="_blank" href="https://www.ghc-gmbh.ch/sicherheit/ab-herbst-2019-ist-die-strong-customer-authentication-notwendig/">payment</a> Solutions geht. Ich verstehe mich als kompetenten Allround Berater, Coach und Projektmanager.</p>
            <p class="font-weight-bold">Zentrales Thema nimmt aber die Online Vermarktung, eCommerce und die Conversion und Lead-Gewinnung durch <a class="text-danger text-decoration-none font-weight-bold" target="_blank" href="https://www.ghc-gmbh.ch/suchmaschinen-optimierung-seo/">search engine optimization (SEO)</a> ,<a href="https://www.ghc-gmbh.ch/google-ads-performance-ads/" target="_blank" class="text-danger text-decoration-none font-weight-bold"> Google Ads &amp; Performance Ads (SEA)</a> ein.</p>
            <p>Für die diversen Projekte arbeite ich mit erfahrenen, hochkarätigen, ausgewählten Partnern zusammen.</p>
            <p class="font-weight-bold mb-0">„Wir stehen erst bei 10% der Möglichkeiten, die das Internet bietet. Packen wir es an“.</p>
        </div>
    </div>
</section>
<?php
