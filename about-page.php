...
<section class="container my-5">
    <div class="row">
        <div class="col-md-6 justify-content-center align-self-center my-4">
            <h1 class="h1 large-font">Full Service Agency for Websites, SEO & eCommerce</h1>
    ...
    <div class="row">
        ...
        <div class="col-md-6 justify-content-center align-self-center my-4">
            <h1 class="h1 large-font">What We Do?</h1>
    ...
    <div class="row">
        <div class="col-md-6 justify-content-center align-self-center my-4">
            <h1 class="h1 large-font">What We Create?</h1>
    ...
    <div class="row">
        ...
        <div class="col-md-6 justify-content-center align-self-center my-4">
            <h1 class="h1 large-font">Founder and CEO</h1>
