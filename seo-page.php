...
<section class="container my-5">
    <div class="row text-center px-5">
        <h2 class="h2 font-medium mx-auto">SEO Agentur Schweiz</h2>
        ...
        <p>Wir sind spezialisiert auf SEO-Optimierung, damit Ihr Unternehmen mehr Besucher anzieht und sie in Kunden umwandelt.</p>
    </div>
    ...
    <div class="row">
        <div class="col-md-6 justify-content-center align-self-center my-4 pr-md-5">
            <img src="<?php echo get_template_directory_uri() . '/assets/images/more-traffic.jpg' ?>" alt="">
        </div>
        <div class="col-md-6 justify-content-center align-self-center my-4 pl-md-5">
            ...
            <p>Wir helfen Ihnen nicht nur dabei, mehr Traffic zu generieren, sondern optimieren auch Ihre Website, damit sie Besucher in Kunden umwandelt. Wir testen verschiedene Elemente auf Ihrer Website und verfolgen die Ergebnisse, damit wir Ihre Konversionsrate weiter verbessern können.</p>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 justify-content-center align-self-center my-4 pr-md-5">
        ...
        <div class="col-md-6 justify-content-center align-self-center my-4 pl-md-5">
            <img src="<?php echo get_template_directory_uri() . '/assets/images/organic-growth.jpg' ?>" alt="">
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 col-lg-4 p-5 pb-0">
            ...
            <p>Es gibt kein SEO ohne Keywords. Um an der Spitze zu stehen, braucht man ordentliche Recherche und gut strukturierte Strategien. Wir von der GHC GmbH bieten unseren Kunden eine detaillierte Keyword-Recherche, um ein Top-Ranking in Ihrer Nische zu erreichen.</p>
        </div>
        <div class="col-md-6 col-lg-4 p-5">
            ...
            <p>Hier kommt On-Page-SEO ins Spiel. Die GHC GmbH hilft Ihnen dabei, die Titel-Tags, Meta-Beschreibungen, Überschriften und Inhalte Ihrer Website zu optimieren, damit Suchmaschinen Ihre Website leicht finden und indexieren können.</p>
        </div>
        <div class="col-md-6 col-lg-4 p-5">
            ...
            <p>Eine SEO Agentur Schweiz hilft Ihnen beim Aufbau hochwertiger Links von Autoritätsseiten in Ihrer Branche durch manuelles Outreaching, Gastbeiträge und viele weitere Möglichkeiten, um Ihr Suchmaschinenranking zu verbessern, und die GHC GmbH ist ein Experte darin.</p>
        </div>
        <div class="col-md-6 col-lg-4 p-5">
            <span class="count-service">04</span>
            <h4>Technisches SEO</h4>
            <p>Technisches SEO ist etwas komplexer, aber für Unternehmen mit grossen oder komplexen Websites unerlässlich. Die GHC GmbH hilft Ihnen dabei, die Architektur, den Code, die Seitengeschwindigkeit, das Schema, die Sitemap, die Seitennavigation und viele andere Dinge Ihrer Website zu optimieren, damit Suchmaschinen Ihre Website problemlos crawlen und indexieren können. Wir beheben auch alle Fehler, die verhindern könnten, dass Ihre Website so hoch rankt, wie sie sollte.</p>
        </div>
        <div class="col-md-6 col-lg-4 p-5">
...
<section class="bg-light p-5">
    <div class="container">
        <h2 class="h2 font-medium py-5">Kontinuierlicher Monatsplan</h2>
        <div class="row">
            <div class="col-md-6">
