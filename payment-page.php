...
<section class="container my-5">
    <div class="text-md-center px-md-5">
        <h2 class="h2 font-medium mx-auto px-0 col-lg-6 mb-3">Payment-Solution integrieren</h2>
        <p class="mx-auto mb-0">Die Payment-Solution in Ihrem Online-Shop sind mit entscheidend für den Erfolg Ihrer Unternehmung. Potentielle Kunden sind heute gewohnt, alle erdenklichen Möglichkeiten für die Bezahlung einer Dienstleistung oder für ein Produkt vorzufinden. Werden diese nicht angeboten, schrecken manche Kunden vor dem Abschluss zurück. Deshalb ist es wichtig die gängigsten Zahlungsmöglichkeiten anzubieten.</p>
    </div>

    <div class="row mt-5">
        <div class="col-md-6 justify-content-center align-self-center pr-md-5 order-2 order-md-1 mt-5 mt-md-0">
            <h2 class="h2 font-medium mb-3">Zahlungslösungen</h2>
...
<section class="mt-5">
    <div class="container">
        <div class="text-md-center">
            <h2 class="h2 font-medium mx-auto mb-5 px-0">Details zu den Zahlungslösungen</h2>
        </div>
        <div class="row">
            <div class="col-md-6 px-md-5">
                <h4 class="mb-3">Rechnungszahlung</h4>
                <p class="mb-0 pb-5">In der Schweiz zahlen sehr viele Kunden immer noch gerne per Rechnung. Bei rund 60 % aller Transaktionen über das Internet, in der Schweiz, wünscht der Kunde eine Lieferung der Ware zusammen mit einer Rechnung und einem Einzahlungsschein. Die meisten Shop-Lösungen bieten gratis Module an, mit denen man diese Payment-Solution im Shop anbieten kann. Das kann man meist selber sehr leicht einrichten. Aber Vorsicht, die Zahlart „per Rechnung“ hat für den Händler oft sehr viele Nachteile und auch hohe Risiken. Im Zweifel können die Kosten und Verluste für diese Payment-Lösung den Vorteil des Mehrumsatz überdecken.</p>
            </div>
            <div class="col-md-6 px-md-5">
                <h4 class="mb-3">Kreditkartenzahlung</h4>
                <p class="mb-2">Kreditkartenzahlung erwartet heute eigentlich jeder Kunde in einem Online-Shop. Nach der Rechnungszahlung ist sie die am meisten benutzte Option im Internet um zu bezahlen. Für den Händler ist es etwas aufwändiger diese einzurichten als andere Payment-Solutions. Um Kreditkarten im Online-Shop akzeptieren zu können benötigt man einen Vertrag mit einem „Kreditkarten Acquirer“ und einem „Kreditkarten/Transaktions Provider“ und man benötigt die für den Shop notwendige Software. Kreditkarten Acquirer wickeln die Zahlungen, die im Shop eingehen, mit der Kreditkarten-Firma ab.</p>
                <p class="mb-2">Acquirer, Provider & Software </p>
                <p class="mb-0 pb-5">Kreditkarten / Transaktions Provider bietet eine technische Lösung über die die Transaktionen aus dem Shop abgewickelt werden. Und die Software für den Shop braucht man um die Daten vom Shop an den Kreditkarten/Transaktions Provider zu übergeben. Der Acquirer und der Kreditkarten/Transaktions Provider können auch ein Unternehmen sein. Der Acquirer und der Provider verlangen meist eine Grundgebühr pro Monat, eine Transaktionsgebühr und eine Gebühr in Prozent von dem Betrag vom Kredikarten-Unternehmen.</p>
            </div>
            <div class="col-md-6 px-md-5">
                <h4 class="mb-3">PayPal</h4>
                <p class="mb-2">PayPal ist eine für Kunden sehr interessante Payment-Solution. Kunden können bei PayPal ein Konto eröffnen und eine Kreditkarte hinterlegen. Treffen sie danach auf einen Shop im Internet der Bezahlung über PayPal anbietet, kann der Kunde diese auswählen und ohne noch einmal die Kreditkarten-Daten einzugeben bezahlen. Der Händler erhält die Kreditkarten-Daten des Kunden nicht. Die Bezahlung wird zwischen Händler und PayPal abgewickelt.</p>
                <p class="mb-2">Sichere und einfache Lösung für den Kunden</p>
                <p class="mb-0 pb-5">Dem Kunden wird der Betrag von PayPal auf die Kreditkarte belastet. Das erspart dem Kunden die Kreditkarten-Daten immer wieder einzugeben und bietet optimalen Datenschutz, denn die Kreditkarten-Daten bleiben nur bei PayPal hinterlegt. Der Händler zahlt pro Betrag eine Gebühr an PayPal, die gleich abgezogen wird. PayPal bietet Kunden auch noch einen Risiko-Schutz.</p>
            </div>
            <div class="col-md-6 px-md-5">
                <h4 class="mb-3">Postfinance Card / E-Payment</h4>
                <p class="mb-0 pb-5">In der Schweiz wird von Online-Shops erwartet, dass man mit der Postfinance Card oder mit Postfinance E-Payment bezahlen kann. Um diese akzeptieren zu können braucht der Händler ein Konto bei der PostFinance, muss die Transaktionen über die PostFinance als Provider abwickeln und er benötigt die entsprechende Software für sein Shop-System. Wie bei Kreditkarten muss man eine Grundgebühr pro Monat und eine Transaktionsgebühr bezahlen.</p>
            </div>
            <div class="col-md-6 px-md-5">
                <h4 class="mb-3">Mobile Payment</h4>
