    ...
    <div class="row mt-5">
        ...
        <div class="col-md-6 p-3">
            <div class="mb-4 p-3 bg-light">
                ...
                <p>Durch die immer stärkere Vernetzung, Globalisierung und Digitalisierung werden zunehmend Projekte und Produkte möglich, die herkömmliche ersetzen werden. Dabei tritt oft ein extremer wirtschaftlicher Vorteil auf, der die Transformation erheblich zu beschleunigen hilft. Auf der einen Seite bietet das enorme Vorteile für alle von uns, zerstört aber auch herkömmliche, alte Strukturen mit all seinen Folgen. Ein Beispiel ist die Elektromobilität bzw. die neuen Mobilitätssysteme. Sie werden die klassische Autoindustrie ersetzen, viele Arbeitskräfte freisetzen und das Leben vieler Menschen verändern. Gleichzeitig schaffen sie neu, aber andere Arbeitsplätze, helfen die Umwelt zu schonen und das Leben für viele einfacherer, sicherer und angenehmer zu gestalten. Auf <a href="https://www.outview.ch/" class="text-danger font-weight-bold text-decoration-none">outview.ch</a> berichten wir über alle Aspekte rund um solche Disruptionen.</p>
            </div>
            <div class="mt-4 p-3 bg-light">
                <div class="bg-danger px-3 pt-3">
