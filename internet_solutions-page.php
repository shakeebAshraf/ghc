...
/**
 * The template for  internet soulutions page
 *
...
/* Template Name: Internet Solutions Page */
...
get_header();
?>
<div class="internet-section jumbotron jumbotron-fluid">
    <div class="container py-5 my-5">
        <div class="text-center">
            <h1 class="h1 large-font font-white mb-4">Web design agency Switzerland</h1>
        </div>
    </div>
</div>
                ...
                <div id="accordion" class="myaccordion">
                    ...
                    <div class="card border-bottom border-danger">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                            <div class="card-body py-0">
                                <p>Ihre Website muss auch auffällig und ansprechend sein, wenn Sie erfolgreich sein möchten. Das Design sollte optisch ansprechend sein und die Aufmerksamkeit der Besucher auf sich ziehen.</p>
                                <p>Das Sprichwort „Ihr erster Eindruck ist Ihr letzter Eindruck“ gilt auch für Websites. Wenn Ihr Website-Design nicht beeindruckend ist, werden die Besucher wahrscheinlich wegklicken und nie wieder zurückkehren.</p>
                                <p>GHC GmbH Website erstellen Schweiz die attraktiv und aufmerksamkeitsstark sind, um einen bleibenden Eindruck Ihrer Marke zu hinterlassen.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card border-bottom border-danger">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                            <div class="card-body py-0">
                                <p>In der heutigen Welt ist es wichtig, ein ansprechendes Website-Design zu haben. Das bedeutet, dass Ihre Website auf allen Geräten, einschließlich Smartphones und Tablets, gut aussieht und ordnungsgemäß funktioniert.</p>
                                <p>Da immer mehr Menschen Mobilgeräte zum Surfen im Internet verwenden, ist es wichtig, dass Ihre Website responsive ist und sich an unterschiedliche Bildschirmgrößen anpassen kann.</p>
                                <p>GHC GmbH Website erstellen Schweiz, die responsive sind und auf allen Geräten angezeigt werden können, vom Desktop-Computer bis zum Mobiltelefon.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card border-bottom border-danger">
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="row border-top border-left border-danger mt-5 mx-1">
            ...
            <div class="col-sm text-center p-2 border-bottom border-right border-danger">
                <div class="h-100 py-3">
                    <img src="<?php echo get_template_directory_uri() . '/assets/images/idea.png' ?>" width="48" alt="Affiliate Marketing">
                    <h5 class="mt-3">Erfahrene Designer</h5>
                </div>
            </div>
            <div class="col-sm text-center p-2 border-bottom border-right border-danger">
                <div class="h-100 py-3">
                    <img src="<?php echo get_template_directory_uri() . '/assets/images/accessibility.png' ?>" width="48" alt="Affiliate Marketing">
                    <h5 class="mt-3">Zugängliches Design</h5>
                </div>
            </div>
            <div class="col-sm text-center p-2 border-bottom border-right border-danger">
                <div class="h-100 py-3">
                    <img src="<?php echo get_template_directory_uri() . '/assets/images/cursor.png' ?>" width="48" alt="Affiliate Marketing">
                    <h5 class="mt-3">Einfach zu navigieren</h5>
                </div>
            </div>
            <div class="col-sm text-center p-2 border-bottom border-right border-danger">
                <div class="h-100 py-3">
                    <img src="<?php echo get_template_directory_uri() . '/assets/images/software.png' ?>" width="48" alt="Affiliate Marketing">
                    <h5 class="mt-3">Neueste Technologien</h5>
                </div>
            </div>
        </div>
    </div>
